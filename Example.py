...
filepath = '"C:\\Users\\saisw\\OneDrive\\Desktop\\Plant_Leaf_Disease_Detection\\model.h5"'
model = load_model(filepath)
print(model)

print("Model Loaded Successfully")

tomato_plant = cv2.imread('"C:\\Users\\saisw\\OneDrive\\Desktop\\Plant_Leaf_Disease_Detection\\Dataset\\test\\Tomato___Bacterial_spot (1).JPG"')
